...
def summarize_selection(source, summary_div) -> str:
...
# --- Main 
def get_datasource() -> ColumnDataSource:
...
def get_plots(source: ColumnDataSource, brusshing_tool) -> List[figure]:
  TOOLTIPS = """
    <div
      class="figure-tootip"
...
def bkapp(doc):
  ...
  sum_btn, brusshing_toggle, select_1, select_2 = get_widgets(source, set_1_name, set_2_name)
  
  summaries_plot, set_1_plot, set_2_plot = get_plots(source, brusshing_toggle)
  
  
  #region Display
  summary_div = Div(text="")
  search_bar, h1, result_list = get_search_bar(source)
